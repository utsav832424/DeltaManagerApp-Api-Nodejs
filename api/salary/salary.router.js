const { createUser,getAll, getAllByCode, update, deleted, downloadExcel, downloadUserWiseExcel, downloadPdf, downloadUserWisePdf, getAdminUserTotal, downloadAdminExcel, downloadAdminPdf, getLastMonthSalaryUser, copySalary, superAdminAddSalary} = require("./salary.controller");
...
router.get("/getLastMonthSalary", getLastMonthSalaryUser);
...
router.post("/copySalary", upload, checkToken, copySalary);
router.post("/addSalaryBySuperAdmin", fileUpload.single('file'), checkToken, superAdminAddSalary);
